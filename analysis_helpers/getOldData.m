...
for a = 1:length(animals)
    ...
    if strcmp(animals{a}, 'kiwi')
        ...
        fixdur = {[200 400 400 450 450 450 400 450 520 500 510 520]./1000, ...
            [200 300 400 400 450 450 500 520 520 520 520 520 520]./1000, ...
            ...
            [800 1000*ones(1, 5) 1100 1100 1100 800 1100 1100], ...
        ...
        fixwin = {[100 100 60 60 60 60 60 60 60 60 60 70], ...
            [100 100 100 70 70 60 60 60 60 80 80 80], [100 100 85 70 70 70 75  75 80*ones(1, 11)], ...
            [100 100 85 75 70 70 70 70 80 80 70*ones(1, 8)], [100 100 50 60 70 70 70 80 80 100 100 80], ...
            [100*ones(1, 4) 75 75], [100 100 100], ...
            [100 80*ones(1,11)], [100 100 100 85 70], [100 100 100 100 100 85 85 80 100 100 100 100]};
